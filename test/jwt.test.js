...
describe("failure tests", function() {
  ...
  it("should throw if no authorization header and credentials are required", async function() {
    await expressjwt({ secret: "shhhh", credentialsRequired: true })(
      req,
      res,
      function(err) {
        assert.ok(err);
...
describe("work tests", function() {
  ...
  it("should work with a secretCallback function that accepts header argument", function() {
    var secret = "shhhhhh";
    var secretCallback = function(req, headers, payload) {
